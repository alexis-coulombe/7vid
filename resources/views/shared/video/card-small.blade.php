<div class="video-card video-card-list">
    ...
    <div class="video-card-body">
        <div class="btn-group float-right right-action">
            <a href="{{ route('video.show', ['video' => $video->id]) }}" class="right-action-link text-gray" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="video-title">
            <a href="#">{{strlen($video->title) > 30 ? substr($video->title,0,30)."..." : $video->title}}</a>
        </div>
