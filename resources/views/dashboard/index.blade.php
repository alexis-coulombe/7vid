                        ...
                        <div class="row">
                            ...
                            <div class="col-7 col-md-8">
                                <div class="numbers">
                                    ...
                                    <p class="card-title">{{ count($subscribers) }}
                                    <p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-7 col-md-8">
                                <div class="numbers">
                                    ...
                                    <p class="card-title">{{ count($videos) }}
                                    <p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-7 col-md-8">
                                <div class="numbers">
                                    ...
                                    <p class="card-title">{{ number_format($totalViews) }}
                                    <p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-7 col-md-8">
                                <div class="numbers">
                                    ...
                                    <p class="card-title">{{ date('Y-m-d', strtotime($user->created_at)) }}
                                    <p>
                                </div>
                            </div>
                        </div>
